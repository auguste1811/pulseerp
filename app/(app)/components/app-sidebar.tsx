...
const groups=[
 ...
 {label:"Intelligence",items:[{href:"/automations",label:"Automatisations",icon:"sparkles"},{href:"/integrations",label:"App Center",icon:"settings"},{href:"/notifications",label:"Notifications",icon:"bell"}]},
